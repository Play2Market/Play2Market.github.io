// ==UserScript==
// @name         FASE BETA | Em Desenvolvimento
...
(function () {
  ...
  const painelURL = "https://Play2Market.github.io/TribalWars/Gemini/A2_Painel.html";
  const STORAGE_KEY = 'amaterasu';
  ...
  function createModal() {
    ...
    closeBtn.addEventListener('mouseleave', () => closeBtn.style.backgroundColor = 'rgba(0,0,0,0.6)');
